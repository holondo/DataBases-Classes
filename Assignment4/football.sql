...
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'MBYA', 'SP', 'BOM', 3);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'paraná', 'PR', 'RUIM', 3);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Guaraní', 'PR', 'BOM', 3);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Charrua', 'RS', 'Lit', 21);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Kambiwá', 'PE', 'BOM', 100);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Parmera', 'SP', 'Par', 5);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Guajajara', 'MA', 'BOM', 25);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Grêmio Prudente', 'SP', 'BOM', 50);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Goitacás', 'GO', 'BOM', 3);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Audax', 'SP', 'BOM', 8);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Tupiniquim', 'RJ', 'BOM', 5);
INSERT INTO EQUIPE VALUES((SELECT MAX(IDEQUIPE) FROM EQUIPE)+1, 'Tupinambá', 'BA', 'BOM', 3);
...
INSERT INTO JOGADOR VALUES('987654321', 'Kwarahy', '05/02/2020', 'BRASILEIRO', 7);
INSERT INTO JOGADOR VALUES('135707531', 'Jasy', '05/02/1999', 'BRASILEIRO', 3);
INSERT INTO JOGADOR VALUES('125634780', 'A', to_timestamp('30/08/1814', 'D/M/Y'), 'BRASILEIRO', 6);
INSERT INTO JOGADOR VALUES('097865341', 'B', to_timestamp('30/07/1998', 'D/M/Y'), 'BRASILEIRO', 12);
INSERT INTO JOGADOR VALUES('125634783', 'Kim Moon', to_timestamp('20/05/2001', 'D/M/Y'), 'Norte Coreano', 10);
INSERT INTO JOGADOR VALUES('125636780', 'Mami', to_timestamp('18/02/0004', 'D/M/Y'), 'BRASILEIRO', 0);
INSERT INTO JOGADOR VALUES('625637780', 'Jon', to_timestamp('30/08/1980', 'D/M/Y'), 'Ingles', 4);
INSERT INTO JOGADOR VALUES('125664780', 'Gabriel Goal', to_timestamp('30/08/1994', 'D/M/Y'), 'Holandes', 2);
INSERT INTO JOGADOR VALUES('125622780', 'Josef', to_timestamp('30/03/2000', 'D/M/Y'), 'BRASILEIRO', 6);
...
INSERT INTO PARTIDA VALUES(7, 5, TO_TIMESTAMP('11/03/2019', 'D/M/Y'),0, 3, 'ITAQUERA');
INSERT INTO PARTIDA VALUES(8, 7, TO_TIMESTAMP('11/03/2019', 'D/M/Y'), 1, 7, 'ARENA BARUERI');
INSERT INTO PARTIDA VALUES(8, 9, TO_TIMESTAMP('11/03/2019', 'D/M/Y'), 4,1, 'MARACANÃ');
INSERT INTO PARTIDA VALUES(6, 4, TO_TIMESTAMP('11/03/2019', 'D/M/Y'), 1, 7, 'ARENA BARUERI');
INSERT INTO PARTIDA VALUES(2, 1, TO_TIMESTAMP('21/05/2017', 'D/M/Y'), 4,1, 'MARACANÃ');
INSERT INTO PARTIDA VALUES(2, 3, TO_TIMESTAMP('21/05/2017', 'D/M/Y'),0, 3, 'ALLIANZ PARK');
INSERT INTO PARTIDA VALUES(7, 5, TO_TIMESTAMP('15/07/2021', 'D/M/Y'), 1, 7, 'ARENA BARUERI');
INSERT INTO PARTIDA VALUES(8, 7, TO_TIMESTAMP('15/07/2021', 'D/M/Y'), 4,1, 'MARACANÃ');
INSERT INTO PARTIDA VALUES(8, 9, TO_TIMESTAMP('15/07/2021', 'D/M/Y'),0, 3, 'ALLIANZ PARK');
INSERT INTO PARTIDA VALUES(6, 4, TO_TIMESTAMP('15/07/2021', 'D/M/Y'), 5, 5, 'GINÁSIO JOSÉ CORREA');

select * from DIRETOR;
SELECT * FROM EQUIPE;
select e1.nome, e2.nome, joga.classico 
from joga
join equipe e1 on e1.idequipe = joga.idequipe1
join equipe e2 on e2.idequipe = joga.idequipe2;
